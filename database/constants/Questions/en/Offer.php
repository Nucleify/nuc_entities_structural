...
return [
    [
        'content' => 'How long does it take to build a website?',
        'answer' => 'Depending on the plan, delivery times range from 5 days for a simple one-page website to 2 weeks for a full MVP. We work efficiently without compromising quality.',
    ],
    [
        'content' => 'Can I request changes after the website is delivered?',
        'answer' => 'Yes! All our plans include revision periods ranging from 7 to 30 days, ensuring you get exactly what you envisioned.',
    ],
    [
        'content' => 'What payment options are available?',
        'answer' => 'We accept all major credit cards through Stripe. You can choose between monthly payments or a one-time payment with a 20% discount.',
    ],
    [
        'content' => 'Is there a money-back guarantee?',
    ...
    [
        ...
        'answer' => 'All our plans include SEO basics. Higher-tier plans come with Google Analytics integration and advanced SEO optimization to help you rank better.',
    ],
];
